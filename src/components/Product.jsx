...
const Product = ({product , getProducts }) => {
  ...
  const deleteProduct = async (id) =>{
    ...
    if(result.isConfirmed){
      try{ await axios.delete(`http://localhost:3000/api/products/${id}`);
  ...
  return (
    <div className="bg-white rounded shadow-lg overflow-hidden">
      ...
      <div className="px-4 pt-2 pb-4">
        ...
        className="inline-block w-full text-center shadow-md text-sm bg-gray-700 text-white rounded-sm px-4 py-1 font-bold hover:bg-gray-600 hover:cursor-pointer">Edit</Link>
